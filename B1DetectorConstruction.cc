...
*/
  ...
  G4ThreeVector pos2 = G4ThreeVector(0*m, -13*m, 0*m);
  // Trap shape       
  G4double shape2_dxa = 54.6*m, shape2_dxb = 54.6*m;
  G4double shape2_dya = 54.5*m, shape2_dyb = 54.7*m;
  G4double shape2_dz  = 5.3*m;      
  G4Trd* solidShape2 =    
